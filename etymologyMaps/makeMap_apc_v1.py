...
## AC: newly defined set of 12 colours from http://colorbrewer2.org/ [qualitative, '12-class Paired']
for i,col in enumerate(colorDic):
	...
	if col=='purple':
		colorDic[i]='#6a3d9a'
	if col=='yellow':
		colorDic[i]='#ffed6f'  ## AC: this yellow is darker one from '12-class Set3' (for some reason the 'Paired' yellow #ffff99 renders as black)
	if col=='brown':
		colorDic[i]='#b15928'
